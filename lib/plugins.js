...
chakram.addMethod("statusRange", function (respObj, low, high) {
    ...
    this.assert(inRange, 'expected '+respObj.response.status+' to be between '+low+' and '+high, 'expected '+respObj.response.status+' not to be between '+low+' and '+high);
});
