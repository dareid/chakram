...
module.exports = function (chai, utils) {
    ...
    utils.addMethod(chai.Assertion.prototype, "schema", function () {
        ...
        var validationResult = tv4.validateMultiple(
            object,
            schema,
            chakram.schemaCyclicCheck,
            chakram.schemaBanUnknown
        );

        var composeErrorMessage = function () {
            var errorMsg =
                "expected body to match JSON schema " + JSON.stringify(schema, null, 2) + ".";
