...
module.exports = function (chai, utils) {
  ...
  utils.addMethod(chai.Assertion.prototype, 'schema', function () {
    ...
    var validationResult = tv4.validateResult(object, schema);
    ...
    var composeErrorMessage = function () {
      ...
      if(validationResult.error !== null) {
        errorMsg += '\n error: ' + validationResult.error.message + '.\n data path: ' + subElement + validationResult.error.dataPath + '.\n schema path: ' + validationResult.error.schemaPath + '.';
      }
      return errorMsg;
    };
