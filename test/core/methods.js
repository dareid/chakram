...
describe("Methods", function () {
    var testWriteMethods = function (testMethod, testUrl) {
        ...
        it("should support non-JSON requests", function () {
            ...
            return response.then(function (resp) {
                ...
                expect(JSON.parse(resp.body).headers["Content-Type"]).not.to.be.equal(
                    "application/json"
                );
            });
        });
    ...
    describe("POST", function () {
        ...
        // NOTE: disabled this test, multipart form data can be created via the form-data package
        // see: https://github.com/node-fetch/node-fetch#post-with-form-data-detect-multipart
    });
    ...
    it("should allow GET requests", function () {
        return chakram.get("http://httpbin.org/get?test=str").then(function (obj) {
